        ...
        try {
            ...
            if (response.success && response.data) {
                ...
                await updateDoc(doc(db, "leads", selectedLead!.id), {
                    ...
                    // NEW: GMB Data
                    Rating: report.businessLogic.reputation.rating || "0.0",
                    ReviewsCount: report.businessLogic.reputation.reviewCount || "0",
                    GmbReviews: report.businessLogic.reputation.reviews || [] // Save reviews array!
                });
